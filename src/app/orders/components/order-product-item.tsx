...
const OrderProductItem = ({orderProduct}: OrderProductItemProps) => {
    ...
    return ( 
        <div className="flex items-center gap-4">
            <div className="bg-accent rounded-lg w-[77px] flex items-center justify-center">
                <Image 
            ...
            <div className="flex flex-col gap-1 w-full">
                <div className="flex bg-accent px-3 py-1 rounded-md w-fit">
                    <p className="text-[10px]">Vendido e entregue por <span className="font-bold">AM Store</span></p>
                </div>
